...
let UsersController = class UsersController {
    ...
    updateTrainingQuizLink(req, section, language, quizUrl) {
        const actor = req.user;
        if (!actor) {
            throw new common_1.ForbiddenException('Unauthorized');
        }
        ...
        return this.usersService.upsertTrainingQuizLink(section, language, quizUrl, actor.role);
    }
    ...
    updateEmployeeLevel(req, userId, levelRaw) {
        ...
        if (!levelRaw ||
            !Object.values(client_1.EmployeeLevel).includes(levelRaw)) {
            throw new common_1.BadRequestException('Invalid employee level');
        }
    ...
    updateEmployeeWorkplaceRole(req, userId, workplaceRoleRaw) {
        const actor = req.user;
        if (!actor || (actor.role !== 'ADMIN' && actor.role !== 'MANAGER')) {
            throw new common_1.ForbiddenException('Only ADMIN and MANAGER can access this resource');
        }
        if (!workplaceRoleRaw ||
            !Object.values(client_1.WorkplaceRole).includes(workplaceRoleRaw)) {
            throw new common_1.BadRequestException('Invalid workplace role');
        }
        return this.usersService.updateEmployeeWorkplaceRole(userId, workplaceRoleRaw, {
            actorId: actor.id,
            actorRole: actor.role,
            actorRestaurantId: actor.restaurantId,
        });
    }
    updateOwnProfile(req, nameRaw) {
        if (!req.user) {
        ...
        if (!name || name.length > 120) {
            throw new common_1.BadRequestException('name must be between 1 and 120 characters');
        }
...
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Update global training access profile for one employee level (admin)',
    }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)('training-quiz-links'),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "listTrainingQuizLinks", null);
__decorate([
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)('training-quiz-links/:section/:language'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('section')),
    __param(2, (0, common_1.Param)('language')),
    __param(3, (0, common_1.Body)('quizUrl')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, String, Object]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "updateTrainingQuizLink", null);
__decorate([
    (0, swagger_1.ApiOperation)({
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Update employee workplace role (admin/manager)' }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)(':id/workplace-role'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Body)('workplaceRole')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, Object]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "updateEmployeeWorkplaceRole", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Update profile for current user' }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
