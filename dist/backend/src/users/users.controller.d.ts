...
export declare class UsersController {
    ...
    listTrainingQuizLinks(req: AuthenticatedRequest): Promise<{
        section: import("../uploads/upload-taxonomy").UploadSection;
        language: "fr" | "bn";
        quizUrl: string | null;
    }[]>;
    updateTrainingQuizLink(req: AuthenticatedRequest, section: string, language: string, quizUrl: string | undefined | null): Promise<{
        section: import("../uploads/upload-taxonomy").UploadSection;
        language: "fr" | "bn";
        quizUrl: null;
    } | {
    ...
    updateEmployeeWorkplaceRole(req: AuthenticatedRequest, userId: number, workplaceRoleRaw: string | undefined): Promise<{
        id: number;
        workplaceRole: import("@prisma/client").$Enums.WorkplaceRole;
    }>;
    updateOwnProfile(req: AuthenticatedRequest, nameRaw: string | undefined): Promise<{
        trainingAccess: import("../uploads/upload-taxonomy").UploadSection[];
        id: number;
        email: string;
        name: string | null;
